package com.gbicc.auth.shiro.jwt;


import com.auth0.jwt.exceptions.SignatureVerificationException;
import com.auth0.jwt.exceptions.TokenExpiredException;
import com.gbicc.entity.Constant;
import com.gbicc.exception.CustomException;
import com.gbicc.utils.JedisUtil;
import com.gbicc.utils.JsonConvertUtil;
...
//                String refreshTokenExpireTime = PropertiesUtil.getProperty("refreshTokenExpireTime");
                ...
                String refreshTokenExpireTime="30";
    ...
    private void response401(ServletResponse response, String msg) {
        ...
        try (PrintWriter out = httpServletResponse.getWriter()) {
            String data = JsonConvertUtil.objectToJson(new ResponseVO(HttpStatus.UNAUTHORIZED.value(), "无权访问(Unauthorized):" + msg, null));
            out.append(data);
        } catch (IOException e) {
