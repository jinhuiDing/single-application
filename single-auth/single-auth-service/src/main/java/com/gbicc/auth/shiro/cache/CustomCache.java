...
public class CustomCache<K,V> implements Cache<K,V> {
    ...
    @Value("shiro.permission.shiroCacheExpireTime")
    private String shiroCacheExpireTime="2000";
